  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-blue-50 to-cyan-50 flex flex-col">
      ...
      <main className="flex-grow container mx-auto px-4 md:px-6 py-6 md:py-12 flex flex-col items-center">
        {/* Telegram Banner - Enhanced to be more clickable */}
        ...
        <div className="w-full max-w-md bg-white rounded-2xl shadow-xl p-6 md:p-8">
          <div className="text-center mb-6">
            ...
            <h2 className="text-2xl font-bold text-gray-800">Find Your Exam Seat</h2>
            <p className="text-gray-600 mt-1">Quick & easy seat lookup for your exams</p>
          </div>
            ...
            <div className="flex">
              <div className="flex-shrink-0">
                ...
                <p className="text-sm text-amber-800">
                  <span className="font-medium">Note:</span> Seat info appears 24h before exams. Not available? Check back later.
                </p>
              </div>
            </div>
          </div>
          ...
          {result && (
            <div className="mt-6 bg-gradient-to-r from-green-50 to-emerald-50 p-5 rounded-xl border border-green-200 shadow-sm">
              <div className="flex items-center mb-4">
                ...
                <h3 className="ml-3 text-lg font-semibold text-green-800">Seat Found!</h3>
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                ...
                <div className="bg-white p-3 rounded-lg shadow-sm border border-green-100 sm:col-span-2">
                  ...
                  <p className="font-semibold text-gray-800">{result.venue.toUpperCase()}</p>
                </div>
              </div>
            </div>
          )}
